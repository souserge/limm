...
You can play it on [the game's itch.io page](https://qw8.itch.io/limm).
 
 The repo also has a [level editor](tools/tilemap_editor), but it is cumbersome to use and the UI is outright awful.
